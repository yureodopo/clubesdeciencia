...
-Se puede visualizar el desarrollo de la pandemia durante la Jornada Nacional de Sana Distancia.Las probabilidades de que haya menos personas suseptibles(azul), probabilidades de que se mantenga constante el número de personas infectadas , probabilidades que que el número de personas recuperadas aumente.
Colima semáforo:
