...
Debido a la propagación del nuevo coronavirus en México, se han implementado medidas preventivas para evitar el aumento de contagios en el país, una de ellas es la cuarentena a través del programa denominado Jornada Nacional de Sana Distancia implementada por el Gobierno Federal.
